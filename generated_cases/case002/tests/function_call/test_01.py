...
_RESULT_PATH = _RESULTS_DIR / "sort_people_by_unit_typical.json"
...
def test():
    ...
    _expected = [People(name='Bob', gender='M', age=25, unit='Alpha'), People(name='Charlie', gender='M', age=35, unit='Beta'), People(name='Alice', gender='F', age=30, unit='Gamma')]
...
if __name__ == "__main__":
    ...
    _RESULT_PATH.write_text(
        json.dumps({
            "test_id": "sort_people_by_unit_typical",
            "passed": passed,
            "actual": _safe(actual),
