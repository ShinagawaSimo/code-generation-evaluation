...
_RESULT_PATH = _RESULTS_DIR / "sort_people_by_unit_returns_new_object.json"
...
def test():
    ...
    _passed = _result is not _input
    return _passed, id(_result), id(_input)
...
if __name__ == "__main__":
    ...
    _RESULT_PATH.write_text(
        json.dumps({
            "test_id": "sort_people_by_unit_returns_new_object",
            "passed": passed,
            "actual": _safe(actual),
