...
def run() -> None:
    ...
    results_dir = Path(run_config.get("results_dir", "artifacts/results/independent_generation"))
    raw_output_dir = Path(run_config.get("raw_output_dir", "artifacts/raw_outputs"))
    default_metrics_inputs = run_config.get("default_metrics_inputs") or {}
    default_metrics_config = run_config.get("default_metrics_config") or {}
    ...
    for case_path in case_paths:
        ...
        runner.run_from_json(
            str(case_path),
            str(output_path),
            default_metrics_inputs=default_metrics_inputs,
