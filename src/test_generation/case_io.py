...
def build_case_output_dir(output_root_dir: str, task_id: str) -> Path:
    return Path(output_root_dir) / task_id


def save_test_generation_result(result_path: str, result: TestGenerationResult) -> None:
